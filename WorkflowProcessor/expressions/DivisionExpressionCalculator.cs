...
{
    internal class DivisionExpressionCalculator : AbstractExpressionValidator
    {
        public DivisionExpressionCalculator(IWorkflowQueries workflowQueries) : base(workflowQueries)
        {
        }
